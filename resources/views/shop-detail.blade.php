        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        <img class="product__details__pic__item--large" src="{{asset('storage/bookcover').'/'.$data->images}}"
                            alt="">
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <ul>
                        <li><b>Stok</b> <span>{{$data->stock}}</span></li>
...
<section class="related-product">
    <div class="container">
        ...
        <div class="row">
            @foreach (App\Category::where('category_name','=',$data->category[0]->category_name)->firstOrFail()->book as $item)    
